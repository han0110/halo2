...
impl Any {
    ...
    pub fn advice() -> Self {
        Self::advice_in(FirstPhase)
    }

    /// Returns Advice variant in given `Phase`
    pub fn advice_in<P: Phase>(phase: P) -> Self {
        Self::Advice(Advice {
...
impl From<Column<Advice>> for Column<Any> {
    fn from(column: Column<Advice>) -> Column<Any> {
        Column {
            index: column.index(),
            column_type: Any::Advice(column.column_type),
        }
    }
}
...
impl From<Column<Instance>> for Column<Any> {
    fn from(column: Column<Instance>) -> Column<Any> {
        Column {
            index: column.index(),
